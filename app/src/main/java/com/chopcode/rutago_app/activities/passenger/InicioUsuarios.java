package com.chopcode.rutago_app.activities.passenger;
...
import com.chopcode.rutago_app.activities.passenger.editProfile.EditarPerfil;
import com.chopcode.rutago_app.activities.passenger.profile.PerfilUsuario;
import com.chopcode.rutago_app.adapters.horarios.HorarioPagerAdapter;
import com.chopcode.rutago_app.config.MyApp;
import com.chopcode.rutago_app.managers.AuthManager;
import com.chopcode.rutago_app.models.Horario;
import com.chopcode.rutago_app.models.Usuario;
import com.chopcode.rutago_app.services.reservations.HorarioService;
...
public class InicioUsuarios extends AppCompatActivity {
    ...
    private int contarReservasActivas(DataSnapshot snapshot) {
        ...
        for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
            com.chopcode.rutago_app.models.Reserva reserva =
                    dataSnapshot.getValue(com.chopcode.rutago_app.models.Reserva.class);
            if (reserva != null) {
