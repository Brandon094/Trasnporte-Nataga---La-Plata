package com.chopcode.rutago_app.activities.driver.profile;
...
import com.chopcode.rutago_app.activities.driver.history.HistorialConductor;
import com.chopcode.rutago_app.activities.driver.InicioConductor;
import com.chopcode.rutago_app.activities.driver.editProfile.EditarPerfilConductor;
...
import com.chopcode.rutago_app.services.reservations.VehiculoService;
...
public class PerfilConductor extends AppCompatActivity {
    ...
    private void cargarDatosUsuarioYCompletar(String nombreConductor, String telefonoConductor, String placaVehiculo, String userId) {
        userService.loadUserData(userId, new UserService.UserDataCallback() {
            @Override
            public void onUserDataLoaded(com.chopcode.rutago_app.models.Usuario usuario) {
                runOnUiThread(() -> {
     ...
     */
    private void actualizarUICompleta(String nombre, String telefono, String placa, com.chopcode.rutago_app.models.Usuario usuario) {
